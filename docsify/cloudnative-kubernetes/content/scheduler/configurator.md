...
[调度器配置](https://kiosk007.top/docsify-book/cloudnative-kubernetes/#/content/scheduler/configuration)中解析了kube-scheduler的各种配置，但是自始至终都没有看到如何根据配置构造[调度器](https://kiosk007.top/docsify-book/cloudnative-kubernetes/#/content/scheduler/scheduler)。虽然[调度器](https://kiosk007.top/docsify-book/cloudnative-kubernetes/#/content/scheduler/scheduler)文章中提到了构造函数，但是其核心实现是Configurator，本文将解析Configurator构造调度器的过程。虽然意义远没有[调度队列](https://kiosk007.top/docsify-book/cloudnative-kubernetes/#/content/scheduler/scheduling_queue)、[调度框架](https://kiosk007.top/docsify-book/cloudnative-kubernetes/#/content/scheduler/framework)、[调度插件](https://kiosk007.top/docsify-book/cloudnative-kubernetes/#/content/scheduler/plugin)等重大，但是对于了解[调度器](https://kiosk007.top/docsify-book/cloudnative-kubernetes/#/content/scheduler/scheduler)从生到死整个过程来说是必要一环，况且确实能学到点东西。
...
Configurator类似于[Scheduler](https://kiosk007.top/docsify-book/cloudnative-kubernetes/#/content/scheduler/scheduler)的工厂，但是一般的工厂类很少会有这么多的配置，所以Configurator这个名字比Factroy更合适。源码链接：https://github.com/kubernetes/kubernetes/blob/release-1.21/pkg/scheduler/factory.go#L59
