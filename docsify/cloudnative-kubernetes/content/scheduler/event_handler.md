...
笔者已经在[调度队列](https://kiosk007.top/docsify-book/cloudnative-kubernetes/#/content/scheduler/scheduling_queue)、[调度框架](https://kiosk007.top/docsify-book/cloudnative-kubernetes/#/content/scheduler/framework)、[调度插件](https://kiosk007.top/docsify-book/cloudnative-kubernetes/#/content/scheduler/plugin)、[调度缓存](https://kiosk007.top/docsify-book/cloudnative-kubernetes/#/content/scheduler/cache)以及[调度扩展器](https://kiosk007.top/docsify-book/cloudnative-kubernetes/#/content/scheduler/extender)等文章中解析了kube-scheduler基本的调度原理与实现，但是有没有发现几个问题？

1. 需要调度的Pod是怎么进入[调度队列](https://kiosk007.top/docsify-book/cloudnative-kubernetes/#/content/scheduler/scheduling_queue)的？
2. 调度完成的Pod是如何被更新到[调度缓存](https://kiosk007.top/docsify-book/cloudnative-kubernetes/#/content/scheduler/cache)的？
3. Node的上线、下线等状态更新是如何更新到[调度缓存](https://kiosk007.top/docsify-book/cloudnative-kubernetes/#/content/scheduler/cache)的？
