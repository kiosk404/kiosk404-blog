...
- 思路：最常见且高效的方法是使用**双指针法**。这种方法只需要一次遍历即可完成任务，避免了两次遍历的开销。
...
- 链接：[https://leetcode.cn/problems/merge-k-sorted-lists/](https://leetcode.cn/problems/merge-k-sorted-lists/)
- 思路：分治法 (Divide and Conquer)  这种方法类似于**归并排序**。我们可以将链表数组不断地对半分割，直到每个子问题都只包含一个或零个链表。然后，我们递归地将这些子链表两两合并。
...
- 链接：[https://leetcode.cn/problems/linked-list-cycle-ii/](https://leetcode.cn/problems/linked-list-cycle-ii/)
- 思路: 快慢指针
